...
import { useMintToken } from "@hooks/tokenfactory/tx/useMintToken"
...
import { type MsgMint } from "juno-network/types/codegen/osmosis/tokenfactory/v1beta1/tx"
...
export const MintModal = ({
	...
	const { isSuccess, mutate: mintToken } = useMintToken()
	const {
					...
					<DrawerBody>
						...
						>
							...
							<MotionFormControl
								...
								gap="0"
								isRequired
								isInvalid={Boolean(errors.mintToAddress)}
							>
								<FormLabel mb="0" htmlFor="mintToAddress">
									Receiver
								</FormLabel>
								<FormErrorMessage
									m="0"
								...
								<Input
									...
									letterSpacing={0.8}
									_placeholder={{ color: "brand.4", letterSpacing: 0.8 }}
									placeholder={address}
									{...register("mintToAddress", {
										required: "Required"
									})}
								/>
							</MotionFormControl>
								...
								<MotionFlex w="full" justify="end" flexDir="row">
									<MotionButton
										...
										onClick={() => {
											...
											if (!watch("mintToAddress")) {
												setValue("mintToAddress", address)
											}
	...
	return (
		<Modal size="xl" isOpen={isOpen} onClose={onClose} isCentered>
			...
			<ModalContent
				...
				borderColor="border.1"
			>
				<ModalHeader>Mint {selectedSubdenom}</ModalHeader>
